...
# ==========================================================
# UPGRADED GLOBAL PARAMS
# ==========================================================
PARAMS = {
    # Zoom: Higher sensitivity makes small pinches result in larger scale changes
    "zoom_min": 0.7,
    "zoom_max": 5.0,
    "zoom_sensitivity": 0.65,  # Increased from 0.18

    # Rotation: Higher multiplier means less wrist twisting required
    "rot_sensitivity": 0.45,   # Increased from 0.15 (significant jump)
    "peel_sensitivity": 0.85,  # Increased from 0.12

    # Drag: Higher value reduces the "elastic" lag when moving the object
    "drag_smooth": 0.55,       # Increased from 0.28 (snappier tracking)
    
    # Timing: Lower hold time makes the freeze trigger faster
    "freeze_hold_time": 0.85,  # Decreased from 0.30

    # Global Smoothing: Higher = more raw/instant. Lower = more buttery/delayed.
    "smooth_alpha": 0.90,      # Increased from 0.25 (less "latency" feel)
}
# ==========================================================
# FLASK SETUP
# ==========================================================
